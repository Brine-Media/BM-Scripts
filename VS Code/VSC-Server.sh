...
# Author: V1d1o7 (Tristan)
# License: GNU GPLv3 | https://github.com/Brine-Media/BM-Scripts/blob/main/LICENSE
...
# Use a background process and trap to ensure script continues
trap 'echo "Process terminated"; exit 0' SIGINT
